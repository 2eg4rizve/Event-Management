...
const About = () => {
    return (
        <div className="mt-[50px] text-center font-bold bg-[url('/public/extra/about4.jpg')] bg-no-repeat bg-cover">
            ...
            <p className="pt-[60px]">
                ...
                We are detail-oriented and organized, and I will ensure that everything runs smoothly on the day of your event.
